...
<html lang="en">
  <head>
    ...
    <title><?php echo $_SESSION['fristName']; ?> - Dashboard </title>
  ...
  <div class="navbar-collapse offcanvas-collapse" id="navbarsExampleDefault">
    ...
    <div class="form-inline my-2 my-lg-0">
      ...
      <form action="inc/logout.php" method="POST">
        <button name="logout" class="btn btn-outline-danger my-2 my-sm-0" type="submit"style="margin-left: 4px;">Logout</button>
      </form>
    </div>
  </div>
</nav>
